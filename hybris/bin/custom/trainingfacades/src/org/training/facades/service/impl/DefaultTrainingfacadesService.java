...
public class DefaultTrainingfacadesService implements TrainingfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingfacadesService.class);
	...
	{
		return DefaultTrainingfacadesService.class.getResourceAsStream("/trainingfacades/sap-hybris-platform.png");
	}
