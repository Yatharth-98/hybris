 ...
 */
package com.mystore.webservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.mystore.webservices.constants.YcommercewebservicesConstants;
import com.mystore.webservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mystorewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mystorewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mystorewebservices.oauth2.tokenUrl";

	private static final String DESC = "mystorewebservices.v2.description";
	private static final String TITLE = "mystorewebservices.v2.title";
	private static final String VERSION = "mystorewebservices.v2.version";
	private static final String LICENSE = "mystorewebservices.v2.license";
	private static final String LICENSE_URL = "mystorewebservices.v2.license.url";
