...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		getCoreDataImportService().synchronizeProductCatalog(this, context, MYSTORE, true);
		getCoreDataImportService().synchronizeContentCatalog(this, context, MYSTORE, true);
