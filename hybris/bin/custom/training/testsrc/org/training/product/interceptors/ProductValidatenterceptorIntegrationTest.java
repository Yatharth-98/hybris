 ...
 */
@IntegrationTest
public class ProductValidatenterceptorIntegrationTest extends ServicelayerTest
{
	...
	public void testOnValidate() throws InterceptorException
	{
		...
		assertNotNull("Name must not be null", productFromDatabase);
	}


	@Test(expected = ModelSavingException.class)
	public void testOnValidateCheckApprovalStatus() throws InterceptorException
	{
		final ProductModel product = modelService.create(ProductModel.class);
	...
	@Test(expected = ModelSavingException.class)
	public void testOnValidateUnapprovedApprovalStatus() throws InterceptorException
	{
		final ProductModel product = modelService.create(ProductModel.class);
	...
	@Test(expected = ModelSavingException.class)
	public void testOnValidateApprovalStatusNotSet() throws InterceptorException
	{
		final ProductModel product = modelService.create(ProductModel.class);
