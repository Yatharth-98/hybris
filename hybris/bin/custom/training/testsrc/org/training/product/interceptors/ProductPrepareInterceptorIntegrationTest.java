 ...
 */
@IntegrationTest
public class ProductPrepareInterceptorIntegrationTest extends ServicelayerTest
{
	...
	public void testOnPrepare() throws InterceptorException
	{
		...
		assertNotNull("Name must not be null", productFromDatabase.getName());
	}
	...
	public void testOnPrepareIfNameAlreadySet() throws InterceptorException
	{
		...
		assertEquals("Incorrect product name", name, productFromDatabase.getName());
	}
}
